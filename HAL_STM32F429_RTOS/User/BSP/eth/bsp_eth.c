...
HAL_StatusTypeDef Bsp_Eth_Init(void)
{
    ...
    MACAddr[5] = 0x00;
    heth.Instance = ETH;
    heth.Init.AutoNegotiation = ETH_AUTONEGOTIATION_ENABLE;   /* ��������Ӧ���� */
    heth.Init.PhyAddress = LAN8720_PHY_ADDRESS;               /* ����PHY��ַ */
    heth.Init.MACAddr = &MACAddr[0];                          /* ����MAC��ַ */          
    heth.Init.RxMode = ETH_RXINTERRUPT_MODE;                  /* ����Ϊ�����ж� */   
    heth.Init.ChecksumMode = ETH_CHECKSUM_BY_HARDWARE;        /* Ӳ������У�� */
    heth.Init.MediaInterface = ETH_MEDIA_INTERFACE_RMII;      /* RMII�ӿ�ģʽ */
    heth.Init.Speed = ETH_SPEED_100M;                         /* �ٶ� */
    heth.Init.DuplexMode = ETH_MODE_FULLDUPLEX;               /* ȫ˫��ģʽ */
