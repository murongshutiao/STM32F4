...
/* Includes ------------------------------------------------------------------*/
#include "./lcd/bsp_ltdc_rgb888.h"
#include "./Common/fonts/font24.c"
#include "./Common/fonts/font20.c"
#include "./Common/fonts/font16.c"
#include "./Common/fonts/font12.c"
#include "./Common/fonts/font8.c"
...
void Lcd_RGB888_Cfg(void)
{
    ...
    LCD_LayerInit(0, LCD_FB_START_ADDRESS,ARGB8888);    /* LCD 第一层初始化 */
    LCD_LayerInit(1, LCD_FB_START_ADDRESS+(LCD_GetXSize()*LCD_GetYSize()*4),ARGB8888);/* LCD 第二层初始化 */ 
    LCD_DisplayOn();    /* 使能LCD，包括开背光 */ 
    LCD_SelectLayer(0); /* 选择LCD第一层 */
    LCD_Clear(LCD_COLOR_BLACK);  /* 第一层清屏，显示全黑 */ 
    LCD_SelectLayer(1);         /* 选择LCD第二层 */
    LCD_Clear(LCD_COLOR_TRANSPARENT);   /* 第二层清屏，显示全黑 */
